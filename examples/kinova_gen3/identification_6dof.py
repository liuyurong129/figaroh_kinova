...
urdf_file = 'examples/kinova_gen3/data/urdf/GEN3-6DOF_NO-VISION_URDF_ARM_V01.urdf'
...
with open('examples/kinova_gen3/data/identification/trapezoidal_motion_6dof/identification_q_simulation.csv', 'r') as f:
...
with open('examples/kinova_gen3/data/identification/trapezoidal_motion_6dof/identification_tau_simulation.csv', 'r') as f:
    csvreader = csv.reader(f)
