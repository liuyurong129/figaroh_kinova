...
def main():
    ...
    robot = Robot(
        'examples/kinova_gen3/data/urdf/GEN3-7DOF-NOVISION_FOR_URDF_ARM_V12.urdf',
        package_dirs=package_dirs
    )
    
    with open('examples/kinova_gen3/config/kinova_gen3_7dof_config.yaml', 'r') as f:
    ...
    active_joints = ["joint_1", "joint_2", "joint_3", "joint_4", "joint_5", "joint_6", "joint_7"]
    freq = 100
    ...
    q0 = [-3, -2.0, -3, -2.5, -3, -2, -3]
    qf = [ 3,  2.0,  3,  2.5,  3,  2,  3]
    ...
    np.savetxt("examples/kinova_gen3/data/identification/trapezoidal_motion_7dof/identification_q_simulation.csv", p_full, delimiter=",", header="q1,q2,q3,q4,q5,q6", comments="")
