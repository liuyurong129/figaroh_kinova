...
from figaroh.identification.identification_tools import get_param_from_yaml, calculate_first_second_order_differentiation, base_param_from_standard, low_pass_filter_data, calculate_standard_parameters, relative_stdev
...
# robot_urdf_path = os.path.join(package_dirs, 'data', 'urdf', 'GEN3-7DOF-NOVISION_FOR_URDF_ARM_V12.urdf')
...
# identification_q_path = os.path.join(package_dirs, 'data','identification','trapezoidal_motion_7dof','identification_q_simulation.csv')
# identification_tau_path = os.path.join(package_dirs, 'data','identification','trapezoidal_motion_7dof','identification_tau_simulation.csv')
