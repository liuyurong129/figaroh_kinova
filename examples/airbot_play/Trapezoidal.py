...
def main():
    ...
    q0 = np.zeros(len(active_joints))
    qf = [np.deg2rad(90), np.deg2rad(-30), np.deg2rad(90),
          np.deg2rad(90), np.deg2rad(90), np.deg2rad(90)]
    ...
    np.savetxt("examples/airbot_play/data/identification/trapezoidal_motion/trapezoidal_q_simulation.csv", p_full, delimiter=",", header="q1,q2,q3,q4,q5,q6", comments="")
