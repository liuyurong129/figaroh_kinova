...
urdf_file = 'examples/airbot_play/data/urdf/updated_robot.urdf'
...
# Build the structural base identification model, i.e., the one that can
...
print("When using all trajectories the cond num is", np.linalg.cond(W_base))
...
print("friction parameters from URDF:")
